...
# Map é uma função que recebe dois parâmetros: O primeiro a função, o segundo o iterável. Retorna um Map Object
...
print(areas)
print(type(areas))
print(list(areas))  # Podemos converter para - list, tuple ...
