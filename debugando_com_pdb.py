...
# A utilização do print() para debugar código é uma pratíca ruim.
...
# do inicio do arquivo. Por isso, ao invés de colocarmos o import do pdb no ínicio do arquivo.
...
# Como os nokes das variáveis são os mesmos do comando pdb, devemos utilizar o comando p para imprimir as variáveis.
